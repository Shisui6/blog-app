...
<details>
  ...
  <ul>
    <li><a href="#-blog-app-">📖 Blog App</a></li>
...
**Blog App** is a fully functional blog website that shows a list of posts and empowers readers to interact with them by adding comments and likes.
